...
//====================================PAYMENT OF SINGLE PRODUCT BY A CARD==========================================//
	@POST// (written by Mayank)
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	@Produces(MediaType.TEXT_PLAIN)
	@Path("/{user_id}/{product_id}/{quantity}")
	public String PaymentValidation(@PathParam("user_id") int user_id, @PathParam("product_id") int product_id,
			@PathParam("quantity") int buy_quantity, @FormParam("card_number") String card_number,
			@FormParam("cvv") String cvv, @FormParam("ex_month") String ex_month,
...
//=====================================PAYMENT OF SINGLE PRODUCT BY A WALLET=======================================//
	@POST// (written by Mayank)
	@Produces(MediaType.TEXT_PLAIN)
	@Path("/wallet/{user_id}/{product_id}/{quantity}")
	public String buyWallet(@PathParam("product_id") int product_id, @PathParam("quantity") int buy_quantity,
