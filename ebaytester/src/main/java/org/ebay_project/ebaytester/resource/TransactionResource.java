...
//======================================GET ALL TRANSACTION AT GIVEN USER_ID=======================================//	
	@GET //(written by Anamol)
...
//=========================================GET TRANSACTION DETAILS AT GIVEN TRACK ID==============================// 	
	@GET //(written by Anamol)
...
//=========================================UPDATE TRANSACTION STATUS BY SELLER====================================//		
...
//======================UPDATE TRANSACTION STATUS BY USER AND TRANSFER MONEY TO GIVEN SELLER======================//	
	@PUT //(written by Anamol)
...
//==============================================RATE PRODUCT BY USER===============================================//
	@PUT //(written by Anamol)
	@Path("/rateSeller/{user_id}/{txn_id}/{product_id}/{stat}/{rating}")
	@Produces(MediaType.TEXT_PLAIN)
	public String rateProduct(@PathParam("user_id") int user_id,
		...
		int txn_id1=Integer.parseInt(txn_id.substring(6));
		TransactionService ts = new TransactionService();
		return ts.rateSeller(user_id,txn_id1,product_id,stat,rate);
	}
