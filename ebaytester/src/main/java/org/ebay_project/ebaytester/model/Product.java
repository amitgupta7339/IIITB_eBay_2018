...
public class Product {
	...
	private int product_id, sub_category_id, category_id, user_id, product_discount,
	...
	public Product(int product_id, int sub_category_id, int category_id, int user_id, float product_price,
